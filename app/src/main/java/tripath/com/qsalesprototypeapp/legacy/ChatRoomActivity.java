...
public class ChatRoomActivity extends BaseActivity implements Handler.Callback,View.OnClickListener{
    ...
    CustomFrameLayout layoutContainer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.testImageView).setOnClickListener( this );
...
//        layoutContainer = (CustomFrameLayout) findViewById( R.id.layoutContainer);
        ...
        webView.addJavascriptInterface( new JavascriptManager( baseHandler ) , "JavascriptManager");
